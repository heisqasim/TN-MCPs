...
**Phases 0–1 are complete. Phase 2 (of phases 0–15), the thin gateway + first MCP
skeleton (local only), is complete on PR #2, pending merge.** Nothing is deployed and
...
is [docs/MASTER_PLAN.md](docs/MASTER_PLAN.md).
